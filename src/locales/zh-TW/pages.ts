export default {
    'pages.layouts.userLayout.title': 'Karinpoky 是西湖區最具影響力的 Web 設計規範',
    'pages.login.accountLogin.tab': '賬戶密碼登錄',
    'pages.login.accountLogin.errorMessage': '錯誤的用戶名和密碼(admin/karinpoky)',
    ...
    'pages.login.password.placeholder': '密碼: karinpoky',
