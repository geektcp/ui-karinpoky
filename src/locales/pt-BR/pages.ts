export default {
    'pages.layouts.userLayout.title':
        'Karinpoky é a especificação de web design mais influente no distrito de Xihu',
    'pages.login.accountLogin.tab': 'Login da conta',
    'pages.login.accountLogin.errorMessage': 'usuário/senha incorreto(admin/karinpoky)',
    ...
    'pages.login.password.placeholder': 'Senha: karinpoky',
