export default {
    'pages.layouts.userLayout.title':
        'Karinpoky adalah spesifikasi desain Web yang paling berpengaruh di Kabupaten Xihu',
    'pages.login.accountLogin.tab': 'Login dengan akun',
    'pages.login.accountLogin.errorMessage': 'Nama pengguna dan kata sandi salah(admin/karinpoky)',
    ...
    'pages.login.password.placeholder': 'kata sandi: karinpoky',
